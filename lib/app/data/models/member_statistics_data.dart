List<MemberStatisticsData> listMemberStatisticsData = [
  MemberStatisticsData(
    name: "นายอลงกรณ์ โนนคู่เขตโขง",
    telephone: "096-998-8444",
    position: "สมาชิก",
    memberDate: "12/02/2566",
    memberLocation: "ศูนย์ส่งเสริมพัฒนาประชาธิปไตยและการเลือกตั้งแขวงลาดยาว",
  ...
  MemberStatisticsData(
    ...
    position: "สมาชิก",
    memberDate: "12/02/2566",
    memberLocation: "ศูนย์ส่งเสริมพัฒนาประชาธิปไตยและการเลือกตั้งแขวงจอมพล",
  ...
  MemberStatisticsData(
    ...
    position: "สมาชิก",
    memberDate: "12/02/2566",
    memberLocation: "ศูนย์ส่งเสริมพัฒนาประชาธิปไตยและการเลือกตั้งแขวงจตุจักร",
...
class MemberStatisticsData {
  String? name, telephone, position, memberDate, memberLocation, address;
  MemberStatisticsData({
    this.name,
    this.telephone,
    this.position,
