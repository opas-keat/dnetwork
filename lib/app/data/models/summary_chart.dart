...
List<SummaryChart> summaryLectuterChart = [
  ...
  SummaryChart(
    icon: Icons.edit_document,
    color: Color.fromARGB(255, 238, 25, 192),
    name: "วิทยากรของรัฐ กรมการพัฒนาชุมชน",
    value: 300,
  ),
  SummaryChart(
    icon: Icons.edit_document,
    color: Color.fromARGB(255, 39, 238, 59),
  ...
  SummaryChart(
    icon: Icons.edit_document,
    color: Color.fromARGB(255, 49, 39, 238),
    name: "วิทยากรของรัฐ",
    value: 250,
  ),
  SummaryChart(
  ...
  SummaryChart(
    icon: Icons.edit_document,
    color: Color.fromARGB(255, 39, 238, 228),
    name: "วิทยากร ส่วนกลาง กกต.",
    value: 250,
  ),
  SummaryChart(
    icon: Icons.edit_document,
    color: Color.fromARGB(255, 238, 142, 39),
