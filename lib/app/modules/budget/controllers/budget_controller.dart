...
class BudgetController extends GetxController {
  ...
  void sort<T>(
    ...
    if (field == "date") {
      ascending
          ? listBudgetStatistics.value.sort((a, b) => a.date.compareTo(b.date))
          : listBudgetStatistics.value.sort((a, b) => b.date.compareTo(a.date));
    } else if (field == "type") {
      ascending
          ? listBudgetStatistics.value.sort((a, b) => a.type.compareTo(b.type))
          : listBudgetStatistics.value.sort((a, b) => b.type.compareTo(a.type));
    } else if (field == "province") {
      ascending
          ? listBudgetStatistics.value
